...
**Discliamer!:** In general, we use only 2-3 models to check for the best one in real world because of time and resource limitation. For learning purpose I have use more than three models.
