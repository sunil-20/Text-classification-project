...
__Text Length__<br>
The following image shows how the text length is distributed across different product classes. We can see from the figure that, the product ID Number 5 has almost 30000 characters which is the class "Debt collection". We can visualize lot of outliers across all the classes. That means, text lenght is highly variant. We can confirm that averege text length is less than 1000 characters in all classes. <br>
